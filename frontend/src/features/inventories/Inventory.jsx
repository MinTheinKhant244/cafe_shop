...
function Inventory() {
  ...
  // Stock Form Data - ⭐ invoiceNo ဖယ်ရှားပြီး
  ...
  // ⭐ handleAddStock မှာ invoiceNo ဖယ်ရှားပြီး
  ...
  return (
    <div className={`${styles.layout} ${isExpanded ? styles.sidebarExpanded : ""}`}>
        ...
        <div className={styles.statsBar}>
          ...
          <div className={styles.statCard}>
            <span className={styles.statValue}>
              {inventory.filter(i => i.quantity <= (i.lowStockThreshold || 10)).length}
            </span>
            <span className={styles.statLabel}>Low Stock</span>
          </div>
          <div className={styles.statCard}>
            <span className={styles.statValue}>
              {inventory.reduce((sum, i) => sum + (i.quantity || 0), 0).toFixed(0)}
            </span>
      ...
      {/* ⭐ Add Stock Modal - Invoice Number ဖယ်ရှားပြီး */}
      {showAddStockModal && selectedItem && (
        <div className={styles.modalOverlay} onClick={() => setShowAddStockModal(false)}>
          <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
            ...
            {/* ⭐ Invoice Number field ကို ဖယ်ရှားပြီး */}
            <div className={styles.formGroup}>
              <label>Notes</label>
              <textarea
                rows="2"
      ...
      {showTransactionModal && selectedItem && transactions[selectedItem.id] && (
